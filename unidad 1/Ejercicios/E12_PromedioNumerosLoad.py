...
qtCreatorFile = "../P07_PromedioNumerosLoad.ui"
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def cargar(self):
      ...
      #TAREA EJ 10 COMO COMPRUEBO SI EL ARCHIVO EXISTE?  (hecho)
      try:
        ...
        print(datos)
        ##Tarea EJ 11 --- EN LUGAR DE SOBREESCRIBIR, CONCATENAR :D! (hecho)
        self.calificaciones += datos
        self.promedio()
        # TAREA EJ 12 -- ASEGURARSE DE QUE SOLO SE PUEDA CARGAR HASTA ANTES DE
        # AGREGAR LA PRIMERA CALIFICACION ... ---- ENABLES Y/O CODIGO (hecho)
        self.btn_cargar.setEnabled(False)
      except FileNotFoundError:
         self.msj(" que crees, no existe el archivo :P ")
